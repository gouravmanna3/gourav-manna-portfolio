...
const Skills = () => {
  return (
    <div className="p-6 md:p-10 text-white " style={skillsStyle}>
      <h1 className=" text-4xl font-bold font-permanentMarker tracking-widest text-center">
        Skills
      </h1>
      <section className="flex flex-col justify-evenly md:flex-row gap-4 mt-8 text-white items-center">
        ...
        <div className="grid grid-cols-4 md:grid-cols-5 gap-y-6 gap-x-12 md:gap-x-16 md:gap-y-8 items-center mt-12 md:my-12">
          {skills.map((skill: SkillsType) => (
            <div className="flex flex-col mx-auto justify-center items-center w-10 md:w-12">
