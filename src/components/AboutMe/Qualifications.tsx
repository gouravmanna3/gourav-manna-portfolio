...
const Qualifications = () => {
  return (
    <div className="py-4 text-xs">
      <p className="text-2xl font-bold">My Awesome Journey</p>
        ...
        {educationData.map((education) => {
          ...
          return (
            <motion.div
              ...
              key={university}
              className="flex gap-x-4 group bg-[#DEF5E5] shadow-lg"
            >
              <div className="h-inherit w-[1px] border-[1px] border-[#77B0AA] relative ml-2">
